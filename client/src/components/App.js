...
<div className="navbar-fixed">
   ...
   <div className="nav-wrapper black lighten-1" >
       ...
       <a  className="brand-logo" style={{marginLeft:'10px'}}><Link to={'/'}><img style={{height:'60px'}}src="https://www.freelogodesign.org/file/app/client/thumb/5cc07f4b-8738-4217-a73c-2b1e3c5151b8_200x200.png?1563292458664"></img>Online Mobile Store </Link></a>
