...
/*for change the front page text */
export default class Footer extends Component {
    render() {
        return (
          /*for change the color of the footer*/
            <div>
         <footer className="page-footer black lighten-1">
          <div className="container">
            <div className="row">
              <div className="col l6 s12">
                ...
                <p>Contact number:  03465388880</p>
                <p>For Email:   sa4441028@gmail.com </p>
              </div>
          ...
          <div className="footer-copyright">
            <div className="container">
            ©2020 by Amir Sheikh. All Rights Reserved.
